    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-edit fa-fw"></i> Pengaduan  </a>
                        </li>
                        <li>
                            <a href="{{route('histori.pengaduan')}}"><i class="fa fa-table fa-fw"></i> Riwayat Pengaduan </a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Tabel Pengaduan</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form role="form" action="{{ route('page.pengaduan') }}" method="POST">
                                            @csrf
                                            <div class="form-group">
                                                <label>Tanggal Aduan</label>
                                                <input class="form-control" name="tgl_pengaduan" type="date">

                                            </div>
                                            <div class="form-group">
                                                <label>NIK</label>
                                                <input class="form-control" placeholder="Enter text" name="nik">
                                            </div>
                                            <div class="form-group">
                                                <label>isi_laporan</label>
                                                <textarea class="form-control" name="isi_laporan" type="text"></textarea>
